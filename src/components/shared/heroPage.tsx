    ...
    <Stack 
      ...
      p={18}>
        ...
        <Stack direction="row" align-items="center" justifyContent="items-start" spacing={0.5}>
          <Image src="/assets/bubble.svg" alt="bubble" height={40} width={40}></Image>
        ...
        This is open to everyone every day and provides primary health care and cutting-edge medicine in a central location
        </Typography>
        <Button sx={{
