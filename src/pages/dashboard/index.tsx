...
const Dashboard = ({user , permission , orgainization, isAuthed, appointments , loginUserData }: any)=>{

  console.log(user , permission , orgainization, isAuthed , appointments , loginUserData );
